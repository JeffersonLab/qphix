...
#ifdef DEBUG
    QDPIO::cout << "k=" << k
                << " p_norm before p_update = " << norm2(p, rb[targetCB]) << endl;
#endif
...
#ifdef DEBUG
    QDPIO::cout << "k=" << k << " p_norm after p_update =" << norm2(p, rb[targetCB])
                << endl;
#endif
...
#ifdef DEBUG
    QDPIO::cout << "k="
                << "  rho=" << rho << " ctmp=" << ctmp << " alpha=" << alpha << endl;
#endif
...
#ifdef DEBUG
    QDPIO::cout << "k=" << k << " r_norm before tmult=" << norm2(r, rb[targetCB])
                << endl;
#endif
    // t = As  = Ar
    //    A(t,r,isign);
