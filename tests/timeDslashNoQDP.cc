...
void timeDslashNoQDP::runTest(const int lattSize[], const int qmp_geom[])
{
        ...
        for (int isign = 1; isign >= -1; isign -= 2) {
            for (int cb = 0; cb < 2; cb++) {
                ...
                for (int repeat = 0; repeat < 3; repeat++) {
                    ...
                    double Gflops = 1320.0f * (double)(iters) *
...
void timeDslashNoQDP::run(const int lattSize[], const int qmp_geom[])
{
