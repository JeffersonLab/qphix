...
int main(int argc, char **argv)
{
    ...
    for (int i = 0; i < iters; i++) {
        ...
        //    tests.addTest(new testTWMDslashFull(By_user, Bz_user, NCores_user,
        //    Sy_user, Sz_user, PadXY_user, PadXYZ_user, MinCt_user, compress12,
        //    prec_user, 8), "testDslashFull_S8" );
        //    tests.addTest(new testTWMDslashFull(By_user, Bz_user, NCores_user,
        //    Sy_user, Sz_user, PadXY_user, PadXYZ_user, MinCt_user, compress12,
        //    prec_user, 16), "testDslashFull_S16" );
    }
