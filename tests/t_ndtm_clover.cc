...
void printHelp()
{
  cout << "t_twm_clover Test Specific Args: -x Lx -y Ly -z Lz -t Lt -i iters "
          "-prec Prec"
       << endl;
...
int main(int argc, char **argv)
{
  ...
  tests.addTest(new testNDTMCloverFull(some_user_args, compress12, prec_user),
                "testNDTMCloverFull");
