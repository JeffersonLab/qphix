                                     ...
                                     const std::string &filename)
{
    ...
    typedef
        typename Geometry<FT2, V2, SOA2, compress>::FourSpinorBlock SpinorInner;
    typedef
        typename Geometry<FT2, V2, SOA2, compress>::SU3MatrixBlock GaugeInner;
    ...
    Geometry<FT, V, S, compress> geom(Layout::subgridLattSize().slice(),
                                      ...
                                      PadXYZ,
                                      MinCt);
    Geometry<FT2, V2, SOA2, compress> geom_inner(
    ...
    InvRichardsonMultiPrec<FT, V, S, compress, FT2, V2, SOA2, compress>
        mixed_solver(M, solver_inner, 0.1, 5000);
...
#if defined(QPHIX_MIC_SOURCE) || defined(QPHIX_AVX512_SOURCE)
    runTest<double, VECLEN_DP, 8, true, half, VECLEN_HP, 16, UD, PhiD>(
