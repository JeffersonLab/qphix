...
void printHelp() 
{ 
       cout << "t_twm_dslash -x Lx -y Ly -z Lz -t Lt -i iters -by BY -bz BZ -c NCores -sy SY -sz SZ  -pxy Pxy -pxyz Pxyz -minct MinCt -compress12 -geom Px Py Pz Pt -prec Prec" << endl;
...
int main(int argc, char **argv)
{
  ...
  timeTWMDslashNoQDP test(By_user, Bz_user, NCores_user, Sy_user, Sz_user, PadXY_user, PadXYZ_user, MinCt_user,  iters, compress12, prec_user);
