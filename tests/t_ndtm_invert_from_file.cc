...
int main(int argc, char **argv)
{
  ...
  tests.addTest(new testNDTMInvertFromFile(By_user, Bz_user, NCores_user, Sy_user, Sz_user, PadXY_user, PadXYZ_user, MinCt_user, compress12,prec_user), "testNDTMInvertFromFile" );
