...
void printHelp()
{
  cout << "t_dslash -x Lx -y Ly -z Lz -t Lt -i iters -by BY -bz BZ -c NCores  -sy "
          "SY -sz SZ  -pxy Pxy -pxyz Pxyz -minct MinCt -compress12 -prec Prec"
       << endl;
...
int main(int argc, char **argv)
{
  ...
  tests.addTest(new testNDTMInvertFromFile(By_user,
                                           Bz_user,
                                           NCores_user,
                                           Sy_user,
                                           Sz_user,
