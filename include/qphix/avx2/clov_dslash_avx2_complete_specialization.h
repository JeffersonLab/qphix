#ifndef QPHIX_CLOV_DSLASH_AVX2_COMPLETE_SPECIALIZATIONS_H
#define QPHIX_CLOV_DSLASH_AVX2_COMPLETE_SPECIALIZATIONS_H
...
#include "qphix/avx2/clov_dslash_avx2_complete_specialization_form.h"
