...
template<> 
inline void
tmdslash_plus_vec<FPTYPE,VEC,SOA,COMPRESS12>(
...
{
#include INCLUDE_FILE_VAR(qphix/avx2/generated/tmf_dslash_plus_body_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
}
#endif
...
template<> 
inline void
tmdslash_minus_vec<FPTYPE,VEC,SOA,COMPRESS12>(
		const Geometry<FPTYPE,VEC,SOA,COMPRESS12>::FourSpinorBlock *xyBase,
		const Geometry<FPTYPE,VEC,SOA,COMPRESS12>::FourSpinorBlock *zbBase,
		const Geometry<FPTYPE,VEC,SOA,COMPRESS12>::FourSpinorBlock *zfBase,
		const Geometry<FPTYPE,VEC,SOA,COMPRESS12>::FourSpinorBlock *tbBase,
...
{
#include INCLUDE_FILE_VAR(qphix/avx2/generated/tmf_dslash_minus_body_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
}
#endif
...
template<>
inline void
tmdslash_achimbdpsi_plus_vec<FPTYPE,VEC,SOA,COMPRESS12>(
		 const Geometry<FPTYPE,VEC,SOA,COMPRESS12>::FourSpinorBlock *xyBase,
		 const Geometry<FPTYPE,VEC,SOA,COMPRESS12>::FourSpinorBlock *zbBase,
		 const Geometry<FPTYPE,VEC,SOA,COMPRESS12>::FourSpinorBlock *zfBase,
		 const Geometry<FPTYPE,VEC,SOA,COMPRESS12>::FourSpinorBlock *tbBase,
...
//		 const FPTYPE mu,
		 ...
		 const unsigned int accumulate[8])
{
#include INCLUDE_FILE_VAR(qphix/avx2/generated/tmf_dslash_achimbdpsi_plus_body_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
}
#endif
...
template<>
inline void
tmdslash_achimbdpsi_minus_vec<FPTYPE,VEC,SOA,COMPRESS12>(
		 const Geometry<FPTYPE,VEC,SOA,COMPRESS12>::FourSpinorBlock *xyBase,
		 const Geometry<FPTYPE,VEC,SOA,COMPRESS12>::FourSpinorBlock *zbBase,
		 const Geometry<FPTYPE,VEC,SOA,COMPRESS12>::FourSpinorBlock *zfBase,
		 const Geometry<FPTYPE,VEC,SOA,COMPRESS12>::FourSpinorBlock *tbBase,
...
//		 const FPTYPE mu,
		 ...
		 const unsigned int accumulate[8])
{
#include INCLUDE_FILE_VAR(qphix/avx2/generated/tmf_dslash_achimbdpsi_minus_body_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
}
#endif
...
template<>
inline void 
tmface_finish_dir_plus<FPTYPE,VEC,SOA,COMPRESS12>(
		       const FPTYPE *inbuf,
		       const Geometry<FPTYPE,VEC,SOA,COMPRESS12>::SU3MatrixBlock *gBase,
		       Geometry<FPTYPE,VEC,SOA,COMPRESS12>::FourSpinorBlock *oBase,
		       const int gOffs[VEC],
...
{
  if(dir == 0) {
#include INCLUDE_FILE_VAR(qphix/avx2/generated/tmf_dslash_face_unpack_from_back_X_plus_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
  }
  else if(dir == 1) {
#include INCLUDE_FILE_VAR(qphix/avx2/generated/tmf_dslash_face_unpack_from_forw_X_plus_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
  }
  else if(dir == 2) {
#include INCLUDE_FILE_VAR(qphix/avx2/generated/tmf_dslash_face_unpack_from_back_Y_plus_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
  }
  else if(dir == 3) {
#include INCLUDE_FILE_VAR(qphix/avx2/generated/tmf_dslash_face_unpack_from_forw_Y_plus_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
  }
  else if(dir == 4) {
#include INCLUDE_FILE_VAR(qphix/avx2/generated/tmf_dslash_face_unpack_from_back_Z_plus_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
  }
  else if(dir == 5) {
#include INCLUDE_FILE_VAR(qphix/avx2/generated/tmf_dslash_face_unpack_from_forw_Z_plus_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
  }
  else if(dir == 6) {
#include INCLUDE_FILE_VAR(qphix/avx2/generated/tmf_dslash_face_unpack_from_back_T_plus_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
  }
  else if(dir == 7) {
#include INCLUDE_FILE_VAR(qphix/avx2/generated/tmf_dslash_face_unpack_from_forw_T_plus_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
  }
  else {
...
template<>
inline void 
tmface_finish_dir_minus<FPTYPE,VEC,SOA,COMPRESS12>(
						 const FPTYPE *inbuf,
						 const Geometry<FPTYPE,VEC,SOA,COMPRESS12>::SU3MatrixBlock *gBase,
						 Geometry<FPTYPE,VEC,SOA,COMPRESS12>::FourSpinorBlock *oBase,
						 const int gOffs[VEC],
...
{
  if(dir == 0) {
#include INCLUDE_FILE_VAR(qphix/avx2/generated/tmf_dslash_face_unpack_from_back_X_minus_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
  }
  else if(dir == 1) {
#include INCLUDE_FILE_VAR(qphix/avx2/generated/tmf_dslash_face_unpack_from_forw_X_minus_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
  }
  else if(dir == 2) {
#include INCLUDE_FILE_VAR(qphix/avx2/generated/tmf_dslash_face_unpack_from_back_Y_minus_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
  }
  else if(dir == 3) {
#include INCLUDE_FILE_VAR(qphix/avx2/generated/tmf_dslash_face_unpack_from_forw_Y_minus_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
  }
  else if(dir == 4) {
#include INCLUDE_FILE_VAR(qphix/avx2/generated/tmf_dslash_face_unpack_from_back_Z_minus_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
  }
  else if(dir == 5) {
#include INCLUDE_FILE_VAR(qphix/avx2/generated/tmf_dslash_face_unpack_from_forw_Z_minus_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
  }
  else if(dir == 6) {
#include INCLUDE_FILE_VAR(qphix/avx2/generated/tmf_dslash_face_unpack_from_back_T_minus_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
  }
  else if(dir == 7) {
#include INCLUDE_FILE_VAR(qphix/avx2/generated/tmf_dslash_face_unpack_from_forw_T_minus_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
  }
  else {
    printf("Invalid dir for unpack boundary\n");
    exit(1);
