...
#pragma omp barrier
				  ...
				  if ( !cantDoPFaces ) {
					  ...
					  completeFaceDir2(tid,tid, nthread,comms->recvFromDir[2*d+0], res_out, u, beta_s,cb, d, 0, 0);
					  completeFaceDir2(tid,tid, nthread,comms->recvFromDir[2*d+1], res_out, u, beta_s, cb, d, 1, 0);
