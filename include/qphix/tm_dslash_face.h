...
void TMDslash<FT, veclen, soalen, compress>::packTMFaceDir(
    int tid,
...
template <typename FT, int veclen, int soalen, bool compress>
void TMDslash<FT, veclen, soalen, compress>::completeTMFaceDir(
    int tid,
    const FT *psi,
    FourSpinorBlock *res,
...
// Recons_add ( 1 + gamma_T )
template <typename FT, int veclen, int soalen, bool compress>
void TMDslash<FT, veclen, soalen, compress>::completeFaceDirAChiMBDPsi(
    int tid,
    const FT *psi,
    FourSpinorBlock *res,
    const SU3MatrixBlock *u,
