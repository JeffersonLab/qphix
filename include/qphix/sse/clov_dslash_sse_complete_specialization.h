#ifndef QPHIX_CLOV_DSLASH_SSE_COMPLETE_SPECIALIZATIONS_H
#define QPHIX_CLOV_DSLASH_SSE_COMPLETE_SPECIALIZATIONS_H
...
#include "qphix/sse/clov_dslash_sse_complete_specialization_form.h"
