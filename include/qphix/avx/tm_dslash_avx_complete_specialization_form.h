...
{
#include INCLUDE_FILE_VAR(qphix/avx/generated/tmf_dslash_plus_body_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
}
#endif
...
{
#include INCLUDE_FILE_VAR(qphix/avx/generated/tmf_dslash_minus_body_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
}
#endif
...
tmdslash_achimbdpsi_plus_vec<FPTYPE,VEC,SOA,COMPRESS12>(
		 ...
		 const unsigned int accumulate[8])
{
#include INCLUDE_FILE_VAR(qphix/avx/generated/tmf_dslash_achimbdpsi_plus_body_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
}
#endif
...
tmdslash_achimbdpsi_minus_vec<FPTYPE,VEC,SOA,COMPRESS12>(
		 ...
		 const unsigned int accumulate[8])
{
#include INCLUDE_FILE_VAR(qphix/avx/generated/tmf_dslash_achimbdpsi_minus_body_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
}
#endif
...
template<>
inline void  
tmface_proj_dir_plus<FPTYPE,VEC,SOA,COMPRESS12>(
...
template<>
inline void  
tmface_proj_dir_minus<FPTYPE,VEC,SOA,COMPRESS12>(
		const typename Geometry<FPTYPE,VEC,SOA,COMPRESS12>::FourSpinorBlock *xyBase,
		const int offs[VEC],
		const int si_prefdist,
		FPTYPE *outbuf,
