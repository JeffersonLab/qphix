#ifndef QPHIX_TM_DSLASH_AVX_COMPLETE_SPECIALIZATIONS_H
#define QPHIX_TM_DSLASH_AVX_COMPLETE_SPECIALIZATIONS_H
...
#include "qphix/avx/tm_dslash_avx_complete_specialization_form.h"
