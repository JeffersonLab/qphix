#ifndef TM_DSLASH_SCALAR_COMPLETE_SPECIALIZATIONS_H_
#define TM_DSLASH_SCALAR_COMPLETE_SPECIALIZATIONS_H_
...
#include "qphix/scalar/tm_dslash_scalar_complete_specialization_form.h"
