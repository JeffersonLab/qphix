#ifndef TM_CLOV_DSLASH_SCALAR_COMPLETE_SPECIALIZATIONS_H
#define TM_CLOV_DSLASH_SCALAR_COMPLETE_SPECIALIZATIONS_H
...
#include "qphix/scalar/tm_clov_dslash_scalar_complete_specialization_form.h"
