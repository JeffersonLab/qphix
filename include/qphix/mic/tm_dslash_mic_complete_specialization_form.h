...
//		 const FPTYPE mu,
		 ...
		 const unsigned int accumulate[8])
{
#include INCLUDE_FILE_VAR(qphix/mic/generated/tmf_dslash_achimbdpsi_plus_body_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
}
#endif
...
//		 const FPTYPE mu,
		 ...
		 const unsigned int accumulate[8])
{
#include INCLUDE_FILE_VAR(qphix/mic/generated/tmf_dslash_achimbdpsi_minus_body_,FPTYPE,VEC,SOA,COMPRESS_SUFFIX)
}
#endif
