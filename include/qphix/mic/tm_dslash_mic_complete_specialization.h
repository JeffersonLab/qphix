#ifndef _TM_DSLASH_MIC_COMPLETE_SPECIALIZATIONS_H_
#define _TM_DSLASH_MIC_COMPLETE_SPECIALIZATIONS_H_
...
#include "qphix/mic/tm_dslash_mic_complete_specialization_form.h"
