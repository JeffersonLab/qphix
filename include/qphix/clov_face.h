...
void ClovDslash<FT, veclen, soalen, compress>::packFaceDir2(
    int gtid,
    int tid,
    int teamsize,
...
//  RECEIVE AND COMPLETE T-FACE FROM FORWARD
template <typename FT, int veclen, int soalen, bool compress>
void ClovDslash<FT, veclen, soalen, compress>::completeFaceDir2(
    int gtid,
    int tid,
    int teamsize,
    const FT *psi,
...
// Recons_add ( 1 + gamma_T )
template <typename FT, int veclen, int soalen, bool compress>
void ClovDslash<FT, veclen, soalen, compress>::completeFaceDirAChiMBDPsi2(
    int gtid,
    int tid,
    int teamsize,
    const FT *psi,
