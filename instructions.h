...
public:
	...
	int numArithmeticInst() const { return 1; }
private:
	const FVec ret; const FVec a; const FVec b; const string mask;
};
...
public:
	...
	int numArithmeticInst() const { return 1; }
private:
	const FVec ret; const FVec a; const FVec b; const FVec c; const string mask;
};
