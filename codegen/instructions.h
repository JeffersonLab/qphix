...
class Instruction
{
 public:
  ...
  virtual int numArithmeticInst() const { return 0; }
  virtual int numDeclarations() const { return 0; }
  virtual int numScopes() const { return 0; }
  virtual int numIfs() const { return 0; }
};
...
{
 public:
  string serialize() const { return "} else {"; }
  int numScopes() const { return 1; }
};
...
class InlineCode : public Instruction
{
 public:
  ...
  string serialize() const { return code; }
 private:
  const string code;
};
...
class MemRefInstruction : public Instruction
{
 public:
  ...
  virtual bool hasGSAddress() const { return false; }
};
...
class DeclareFVec : public Instruction
{
 public:
  ...
  string serialize() const;
  int numDeclarations() const { return 1; }
...
class InitFVec : public Instruction
{
 public:
  ...
  string serialize() const;
  int numDeclarations() const { return 0; }
...
{
 public:
  DeclareMask(string name_, string value_ = "")
...
class LoadFVec : public MemRefInstruction
{
 public:
  ...
  MemRefType getType() const { return LOAD_ALIGNED_VEC; }
 private:
  const FVec v;
  const Address *a;
  const string mask;
...
class StoreFVec : public MemRefInstruction
{
 public:
  ...
  string serialize() const;
  const Address *getAddress() const { return a; }
  MemRefType getType() const { return STORE_VEC; }
...
{
 public:
  GatherFVec(const FVec &v_,
             const GatherAddress *a_,
             const string mask_)
      : v(v_), a(a_), mask(mask_)
  {
  }
  string serialize() const;
  const Address *getAddress() const { return a; }
  MemRefType getType() const { return GATHER_VEC; }
  virtual bool hasGSAddress() const { return true; }
 private:
  const FVec v;
...
{
 public:
  ScatterFVec(const FVec &v_, const GatherAddress *a_)
      : v(v_), a(a_)
  {
  }
  string serialize() const;
  const Address *getAddress() const { return a; }
  MemRefType getType() const { return SCATTER_VEC; }
  virtual bool hasGSAddress() const { return true; }
 private:
  const FVec v;
  const GatherAddress *a;
...
class LoadBroadcast : public MemRefInstruction
{
 public:
  ...
  string serialize() const;
  const Address *getAddress() const { return a; }
  MemRefType getType() const { return LOAD_NONVEC; }
 private:
  const FVec v;
  const Address *a;
};
...
class PrefetchL1 : public MemRefInstruction
{
 public:
  ...
  MemRefType getType() const { return L1_PREFETCH; }
  const Address *getAddress() const { return a; }
...
class PrefetchL2 : public MemRefInstruction
{
 public:
  ...
  MemRefType getType() const { return L2_PREFETCH; }
  const Address *getAddress() const { return a; }
...
class GatherPrefetchL1 : public MemRefInstruction
{
 public:
  ...
  string serialize() const;
  const Address *getAddress() const { return a; }
  MemRefType getType() const { return GATHER_PREFETCH_L1; }
  virtual bool hasGSAddress() const { return true; }
 private:
  const GatherAddress *a;
  string hint;
...
class GatherPrefetchL2 : public MemRefInstruction
{
 public:
  ...
  string serialize() const;
  const Address *getAddress() const { return a; }
  MemRefType getType() const { return GATHER_PREFETCH_L2; }
  virtual bool hasGSAddress() const { return true; }
 private:
  const GatherAddress *a;
  string hint;
...
/// Copy, `ret = a`.
inline void movFVec(InstVector &ivector,
                    const FVec &ret,
                    const FVec &a,
                    string mask)
{
...
inline void mulFVec(InstVector &ivector,
                    const FVec &ret,
                    const FVec &a,
                    const FVec &b,
                    string mask = "")
...
/// Addition, `ret = a + b`.
inline void addFVec(InstVector &ivector,
                    const FVec &ret,
                    const FVec &a,
                    const FVec &b,
                    string mask = "")
...
/// Subtraction, `ret = a - b`.
inline void subFVec(InstVector &ivector,
                    const FVec &ret,
                    const FVec &a,
                    const FVec &b,
                    string mask = "")
...
inline void fmaddFVec(InstVector &ivector,
                      const FVec &ret,
                      const FVec &a,
                      const FVec &b,
                      const FVec &c,
...
inline void fnmaddFVec(InstVector &ivector,
                       const FVec &ret,
                       const FVec &a,
                       const FVec &b,
                       const FVec &c,
...
inline void loadFVec(InstVector &ivector,
                     const FVec &ret,
                     const Address *a,
                     string mask)
{
...
inline void storeFVec(InstVector &ivector,
                      const FVec &ret,
                      const Address *a,
                      int isStreaming)
{
...
inline void loadBroadcastScalar(InstVector &ivector,
                                const FVec &ret,
                                string scalar_name,
                                int type = 0)
{
  ivector.push_back(new LoadBroadcast(
      ret, new AddressOfScalar(scalar_name, type)));
}
...
inline void declareMask(InstVector &ivector,
                        const string name,
                        const string value = "")
{
...
inline void intToMask(InstVector &ivector,
